...
class OfflineGamePage2 extends StatefulWidget {
  @override
  _OfflineGamePageState2 createState() => _OfflineGamePageState2();
}

class _OfflineGamePageState2 extends State<OfflineGamePage2> {
  bool whiteSide = true;
  ...
  void initState() {
    ...
    chessBoardController.game.load('4r1rk/5K1b/7R/R7/8/8/8/8 w - - 0 1');
    super.initState();
  }
